...
'.$content.'
        ...
        protected function _drawRectangle($x, $y, $w, $h, $border, $padding, $margin, $background)
        {
            ...
            // if ($inTL[0]<=0 || $inTL[1]<=0) $inTL = null; //commented 
            // if ($inTR[0]<=0 || $inTR[1]<=0) $inTR = null; //commented
            // if ($inBR[0]<=0 || $inBR[1]<=0) $inBR = null; //commented
            // if ($inBL[0]<=0 || $inBL[1]<=0) $inBL = null; //commented
